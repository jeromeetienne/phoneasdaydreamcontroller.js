...
/**
 * [_initModel description]
 * @return {[type]} [description]
 */
THREEx.DaydreamController.prototype._initModel = function () {
	// Create 3D objects.
...
THREEx.DaydreamController.prototype.updatePosition = function(camera, gamepad){
	...
	var phoneModel = _this._phoneModel
	...
	_this.object3d.quaternion.copy(poseQuaternion)
